    ...
    const services: ServiceItem[] = [
        {
            ...
            description: "Professional design and planning for efficient network infrastructure",
            icon: <Network className="w-6 h-6" />
        },
        {
            id: 2,
            title: "Data, Voice, Optic Fiber & Data Center Structured Cabling",
            description: "Complete structured cabling solutions for all connectivity needs",
            icon: <Cable className="w-6 h-6" />
        },
        {
            id: 3,
            title: "Installation of Copper, Optic Fiber Cables & Accessories",
            description: "Professional installation of all cable types and related accessories",
            icon: <Settings className="w-6 h-6" />
        },
        {
            id: 4,
            title: "Copper Infrastructure (Cat 5e, Cat 6, Cat 6a)",
            description: "Expert termination services for high-performance copper cabling",
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    <div className="inline-block px-4 py-2 bg-[#002970]/10 rounded-full mb-6">
                        <span className="text-[#004FCB] font-semibold text-sm">NETWORKING SOLUTIONS</span>
                    </div>

                    <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#002970]">
                        Professional <span className="text-[#004FCB]">Networking</span> Infrastructure Services
                    </h1>

                    <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                        Enterprise-grade infrastructure services that connect, secure, and optimize your digital environment.
                        Trusted by businesses for reliable, high-performance networking solutions.
                    </p>

                    <div className="flex flex-wrap justify-center gap-3 mb-8">
                        {features.map((feature, index) => (
                            <div key={index} className="flex items-center gap-2 bg-[#002970]/5 rounded-full px-4 py-2">
                                <CheckCircle className="w-4 h-4 text-[#004FCB]" />
                                <span className="text-[#002970] text-sm font-medium">{feature}</span>
                            </div>
                        ))}
                    </div>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 text-sm">Industry-certified professionals</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 text-sm">2-hour emergency response</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 text-sm">5-year service warranty</div>
                        </div>
                    </div>
                </div>
            </div>

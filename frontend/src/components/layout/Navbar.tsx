  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-gray-100 bg-white/90 backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Navbar Height set here at h-20 */}
        <div className="flex h-20 items-center justify-between">
          {/* Logo Section - Height set to h-full to span the container */}
          ...
          <div className="hidden md:block">
            <Link
              to="/contact"
              className="rounded-lg bg-[#004FCB] hover:bg-[#002970] px-7 py-2.5 text-sm font-bold text-white shadow-md shadow-sky-100 transition-all hover:shadow-lg active:scale-95"
            >
              Contact Us
            </Link>
          </div>
        ...
        <div className="space-y-1 px-4 pb-6 pt-2">
          ...
          <div className="pt-4">
            <Link
              to="/contact"
              onClick={() => setIsOpen(false)}
              className="block w-full rounded-xl bg-[#004FCB] py-4 text-center text-lg font-bold text-white"
            >
              Contact Us
            </Link>
          </div>

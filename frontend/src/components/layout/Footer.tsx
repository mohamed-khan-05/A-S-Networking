          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center mb-6">
              <img
                ...
                alt="Company Logo"
                className="h-30 w-50" // Makes logo white for dark bg
              />
            </div>
            <p className="text-sm leading-relaxed text-slate-400">
              Leading the industry in precision networking infrastructure. From
              fiber optic fusion splicing to large-scale structured cabling, we
              build the backbone of modern business communication.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-start gap-3">
                <svg
                  className="h-5 w-5 text-sky-500 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >

  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: lightBg }}>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, ${darkBlue} 0%, ${brightBlue} 100%)`,
        }}
      >
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          ></div>
          <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_49%,rgba(255,255,255,.1)_50%,transparent_51%)] bg-[length:100px_100px]"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20">
          <div className="text-center text-white">
            ...
            <h1 className="text-6xl md:text-7xl font-bold mb-6 tracking-tight">
              A&S <span className="text-white/95">NETWORKING</span>
            </h1>
            <div className="h-2 w-56 bg-white/40 rounded-full mx-auto mb-8"></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-5xl mx-auto">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="bg-white/10 backdrop-blur-sm rounded-xl p-5 text-center border border-white/20 shadow-lg hover:bg-white/20 hover:scale-105 transition-all duration-300"
                >

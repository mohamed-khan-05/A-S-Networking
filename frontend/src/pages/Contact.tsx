    ...
    <div className="bg-white min-h-[90vh]">
      ...
      <div className="bg-slate-50 py-16 overflow-hidden border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-8">
          <h2 className="text-base font-bold text-[#002970] tracking-widest uppercase">
            Contact Our Field Team
          </h2>
        </div>

        {/* The Marquee Row - Pauses on hover via 'pause-container' class in CSS */}

        <div className="pause-container relative flex overflow-hidden bg-white py-8 border-y border-gray-200 shadow-sm">
          {/* Edge Fades */}
          ...
          {/* This div stops moving because of the .pause-container:hover CSS rule */}
          <div className="animate-marquee flex whitespace-nowrap items-center">
            {displayPhrases.map((text, index) => (
              <div key={index} className="flex items-center mx-12">
                ...
                {/* Custom Networking Separator using brand Color [#004FCB] */}
                <div className="ml-24 flex items-center space-x-3">
                  <div className="h-[2px] w-12 bg-[#004FCB]/20"></div>
                  <div className="h-3 w-3 rounded-full border-2 border-[#004FCB] bg-white"></div>
                  <div className="h-[2px] w-12 bg-[#004FCB]/20"></div>
                </div>
              </div>
            ))}
        ...
        <div className="mt-10 text-center px-4">
          <p className="text-gray-500 font-medium max-w-xl mx-auto">
            Our technicians are ready for dispatch. Contact us for fiber
            splicing, cable runs, and infrastructure audits.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-8 lg:grid-cols-3">
          ...
          <div className="flex flex-col items-center p-10 bg-white rounded-3xl border border-gray-100 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1">
            <div className="flex items-center justify-center h-14 w-14 rounded-2xl bg-[#002970] text-white mb-6 shadow-lg shadow-[#004FCB]/20">
              <svg
          ...
          <div className="flex flex-col items-center p-10 bg-white rounded-3xl border border-gray-100 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <span className="mt-6 text-[#004FCB] font-bold uppercase tracking-widest text-[10px] bg-blue-50 px-2 py-1 rounded">
              Technicians On Call
            </span>
          </div>
        </div>
